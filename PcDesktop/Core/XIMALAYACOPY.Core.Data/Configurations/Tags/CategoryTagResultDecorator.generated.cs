...
namespace XIMALAYACOPY.Core.Data
{
    ...
    public partial class CategoryTagResultDecorator<T> : Decorator<T>
    {
        ...
        public CategoryTagResultDecorator(Result<T> result)
            : base(result)
        {
        ...
        public override void doAddConfig()
        {
            ...
            this.Config.MapType<CategoryTagResult>(map => map
                    ...
                    .Field<XIMALAYACOPY.Core.Models.Tags.TagData[]>(field => field.List, type => type.To("list"))
