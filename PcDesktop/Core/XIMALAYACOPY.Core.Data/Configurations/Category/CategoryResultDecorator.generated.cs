...
//     重新生成代码，这些更改将会丢失。
//		如存在本生成代码外的新需求，请在相同命名空间下创建同名分部类实现 CategoryResultConfigurationAppend 分部方法。
// </auto-generated>
using System;
...
namespace XIMALAYACOPY.Core.Data
{
    ...
    public partial class CategoryResultDecorator<T> : Decorator<T>
    {
        ...
        public CategoryResultDecorator(Result<T> result)
            : base(result)
        {
        ...
        public override void doAddConfig()
        {
            ...
            this.Config.MapType<CategoryResult>(map => map
                    ...
                    .Field<XIMALAYACOPY.Core.Models.Category.CategoryData[]>(field => field.List, type => type.To("data"))
