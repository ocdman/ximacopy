...
//     重新生成代码，这些更改将会丢失。
//		如存在本生成代码外的新需求，请在相同命名空间下创建同名分部类实现 SoundData3ConfigurationAppend 分部方法。
// </auto-generated>
using System;
...
namespace XIMALAYACOPY.Core.Data
{
    ...
    public partial class SoundData3Decorator<T> : Decorator<T>
    {
        ...
        public SoundData3Decorator(Result<T> result)
            : base(result)
        {
