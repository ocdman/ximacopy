...
//     重新生成代码，这些更改将会丢失。
//		如存在本生成代码外的新需求，请在相同命名空间下创建同名分部类实现 AlbumInfoResult1ConfigurationAppend 分部方法。
// </auto-generated>
using System;
...
namespace XIMALAYACOPY.Core.Data
{
    ...
    public partial class AlbumInfoResult1Decorator<T> : Decorator<T>
    {
        ...
        public AlbumInfoResult1Decorator(Result<T> result)
            : base(result)
        {
        ...
        {
            base.doAddConfig();
            this.Config.MapType<AlbumInfoResult1>(map => map
                    ...
                    .Field<XIMALAYACOPY.Core.Models.Album.AlbumData[]>(field => field.List, type => type.To("list"))
